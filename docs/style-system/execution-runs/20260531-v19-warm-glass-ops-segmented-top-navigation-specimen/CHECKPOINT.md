...
Starting HEAD: `f5d3fd5 feat: add warm glass agent card specimen`

## Goal

Add a Style Lab-only Warm Glass Ops segmented top navigation recipe/specimen.
...
- top nav sits as a central warm glass capsule over the scene
...
- rounded warm glass segmented nav shell
...
- warm glass top chrome hierarchy inside the local scene preview
...
- `docs/style-system/execution-runs/20260531-v19-warm-glass-ops-segmented-top-navigation-specimen/CHECKPOINT.md`
...
- View: Panels, View: Graph, Cyberpunk, Apple, Tesla, and Terminal labels were
  present.
