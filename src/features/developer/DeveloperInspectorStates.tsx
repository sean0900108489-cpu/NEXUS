/**
 * NEXUS Window OS — Developer Inspector States
 *
 * Shared states for the developer inspector.
 *
...
export function DevErrorState({ message, onRetry }: { message: string; onRetry: () => void }) {
  return (
