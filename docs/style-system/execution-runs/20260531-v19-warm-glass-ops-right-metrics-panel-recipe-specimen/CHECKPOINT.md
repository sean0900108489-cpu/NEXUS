# V19 Warm Glass Ops Right Metrics Panel Recipe Specimen

Date: 2026-05-31

Branch: `codex/v19-production-shell-style-upgrade`

Starting HEAD: `e4fc5e8 feat: add warm glass scene preview`

## Goal

Add a Style Lab-only Warm Glass Ops right metrics panel recipe/specimen.
...
- warm glass panel hierarchy inside the local scene preview
...
- `docs/style-system/execution-runs/20260531-v19-warm-glass-ops-right-metrics-panel-recipe-specimen/CHECKPOINT.md`
...
left-side Warm Glass identity using direct aliases and local preview data.
