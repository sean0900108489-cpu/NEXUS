...
const productionChromeSmokeVariables = [
  ...
  ["--nexus-command-palette-blur", "18px"],
  ["--nexus-modal-shell-bg", "rgb(88 28 135 / 0.92)"],
  ["--nexus-modal-shell-border", "rgb(251 113 133 / 0.84)"],
  ["--nexus-modal-shell-shadow", "0 0 0 2px rgb(251 113 133 / 0.28), 0 24px 72px rgb(88 28 135 / 0.42)"],
  ["--nexus-modal-shell-radius", "14px"],
  ["--nexus-modal-shell-blur", "20px"],
  ["--nexus-datapad-shell-bg", "rgb(6 78 59 / 0.92)"],
  ["--nexus-datapad-shell-border", "rgb(52 211 153 / 0.88)"],
  ["--nexus-datapad-shell-shadow", "0 0 0 2px rgb(52 211 153 / 0.28), 0 24px 72px rgb(6 78 59 / 0.42)"],
  ["--nexus-datapad-shell-radius", "12px"],
  ["--nexus-datapad-shell-blur", "18px"],
