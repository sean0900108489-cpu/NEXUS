...
- Its primitive specimen gallery includes Panel, Button, Input, Badge, specimen-only static Window and Modal visual shells, and a visual-only Command Palette specimen.
...
| Primitive gallery | Shows Panel/Button/Input/Badge/Window/Modal/Command Palette specimens. | Specimen-only, no production component migration. |
