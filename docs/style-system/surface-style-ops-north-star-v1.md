# Surface Style Ops North Star V1
...
NEXUS Surface Style Ops is the next north star skin for the V19 production shell.
...
Surface Style Ops should bias tokens toward:
...
- `accent.secondary`: soft neutral-green for limited status emphasis
...
- `surfaceStyleOpsSkinPackV2Fixture`
- a pure production alias coverage report
- a Style Lab `Surface Style Ops Coverage` panel
...
Surface Style Ops moves V19 from alias collection toward outcome-driven readiness.
...
Loop `20260531-v19-surface-style-ops-production-alias-bridge-expansion` upgrades
Surface Style from mostly fallback-driven production alias evidence to direct
...
Surface Style fixture can compile into a preview/readiness Bridge Plan that emits
