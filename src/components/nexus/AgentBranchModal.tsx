...
export function AgentBranchModal({
  ...
  return (
    ...
    >
      ...
      >
        <header className="flex items-center justify-between border-b border-neutral-300/15 px-5 py-4">
          <div className="flex items-center gap-3">
            <span className="grid h-9 w-9 place-items-center border border-neutral-300/30 bg-neutral-300/10 text-neutral-100">
          ...
          <button
            ...
            className="grid h-8 w-8 place-items-center border border-white/10 text-neutral-400 transition hover:border-neutral-300/40 hover:bg-neutral-300/10 hover:text-neutral-100 disabled:cursor-wait disabled:opacity-40"
            disabled={busy}
            onClick={onClose}
            type="button"
          >
        ...
        {failed ? (
          <div className="grid gap-4 p-5">
            <section className="border border-neutral-300/40 bg-neutral-300/[0.08] p-5 shadow-[0_0_34px_rgba(244,63,94,0.14)]">
              <div className="font-mono text-[11px] uppercase tracking-[0.2em] text-neutral-100">
                Compression Recovery Protocol
              </div>
              <p className="mt-3 text-sm leading-6 text-neutral-50">
              ...
              <div className="mt-5 grid gap-2 sm:grid-cols-3">
                <button
                  className="border border-neutral-300/45 bg-neutral-300/12 px-3 py-3 font-mono text-[10px] uppercase tracking-[0.14em] text-neutral-100 transition hover:bg-neutral-300/22 hover:shadow-[0_0_22px_rgba(217,70,239,0.14)]"
                  onClick={() => {
                    setMode("summary");
                ...
                <button
                  className="border border-neutral-300/45 bg-neutral-300/12 px-3 py-3 font-mono text-[10px] uppercase tracking-[0.14em] text-neutral-100 transition hover:bg-neutral-300/22 hover:shadow-[0_0_22px_rgba(34,211,238,0.14)]"
                  onClick={() => {
                    setMode("full");
                ...
                <button
                  className="border border-white/10 bg-black/35 px-3 py-3 font-mono text-[10px] uppercase tracking-[0.14em] text-neutral-300 transition hover:border-neutral-300/35 hover:bg-neutral-300/10 hover:text-neutral-100"
                  onClick={onClose}
                  type="button"
                >
                  [ Cancel ]
          ...
          <div className="grid gap-4 p-5">
            ...
            <div>
              ...
              <div className="mt-1 font-mono text-sm uppercase tracking-[0.16em] text-neutral-100">
                {agent.callsign}
              </div>
            </div>
            <div>
              ...
              <div className="mt-1 truncate text-sm text-neutral-200">{agent.model}</div>
            </div>
          </section>
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <button
                className={`border px-4 py-3 text-left transition ${
                  mode === "full"
                    ? "border-neutral-300/55 bg-neutral-300/12 text-neutral-50 shadow-[0_0_22px_rgba(34,211,238,0.13)]"
                    : "border-white/10 bg-black/25 text-neutral-400 hover:border-neutral-300/25 hover:text-neutral-100"
                }`}
                disabled={busy}
              ...
              <button
                className={`border px-4 py-3 text-left transition ${
                  mode === "summary"
                    ? "border-neutral-300/55 bg-neutral-300/12 text-neutral-50 shadow-[0_0_22px_rgba(217,70,239,0.13)]"
                    : "border-white/10 bg-black/25 text-neutral-400 hover:border-neutral-300/25 hover:text-neutral-100"
                }`}
                disabled={busy}
          ...
          {mode === "summary" ? (
            <section className="grid gap-4 border border-neutral-300/20 bg-neutral-300/[0.045] p-4">
              <div className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.18em] text-neutral-100">
              ...
              <label className="grid gap-2">
                ...
                <select
                  className="h-10 border border-white/10 bg-black/45 px-3 font-mono text-xs text-neutral-100 outline-none transition focus:border-neutral-300/55"
                  disabled={busy}
              ...
              <label className="relative grid gap-2">
                <span className="flex items-center justify-between gap-3 font-mono text-[10px] uppercase tracking-[0.16em] text-neutral-500">
                  Custom Focus Prompt
                  <span className="border border-neutral-300/25 px-2 py-0.5 text-[9px] text-neutral-100">
                    Layer 2 Active
                  </span>
                </span>
                <textarea
                  className="min-h-24 resize-none border border-white/10 bg-black/35 p-3 text-xs leading-5 text-neutral-200 outline-none transition placeholder:text-neutral-600 focus:border-neutral-300/55 focus:bg-black/45 disabled:cursor-wait disabled:opacity-55"
                  disabled={busy}
              ...
              <div className="border border-white/10 bg-black/25 p-3">
                <div className="mb-3 flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.16em] text-neutral-500">
                  <SlidersHorizontal className="h-3.5 w-3.5" />
                  Advanced Evaluation Weights
                  <span className="ml-auto border border-neutral-300/25 px-2 py-0.5 text-[9px] text-neutral-100">
                    0-10
                  </span>
                </div>
                <div className="grid gap-3">
                  <label className="grid gap-1.5">
                    <span className="flex items-center justify-between gap-3 font-mono text-[10px] uppercase tracking-[0.14em] text-neutral-400">
                      Architecture Weight
                    ...
                    <input
                      className="accent-neutral-300 disabled:cursor-wait disabled:opacity-55"
                      disabled={busy}
                      max={10}
                      min={0}
                      onChange={(event) =>
        ...
        {!failed ? (
          <footer className="flex items-center justify-end gap-2 border-t border-white/10 px-5 py-4">
            <button
              className="h-9 border border-white/10 bg-black/25 px-4 font-mono text-[10px] uppercase tracking-[0.16em] text-neutral-400 transition hover:border-white/25 hover:text-neutral-100"
              disabled={busy}
              onClick={onClose}
              type="button"
            >
            ...
            <button
              className="h-9 border border-neutral-300/45 bg-neutral-300/12 px-4 font-mono text-[10px] uppercase tracking-[0.16em] text-neutral-100 transition hover:bg-neutral-300/20 hover:shadow-[0_0_20px_rgba(34,211,238,0.16)] disabled:cursor-wait disabled:opacity-55"
              disabled={busy}
              onClick={() => {
