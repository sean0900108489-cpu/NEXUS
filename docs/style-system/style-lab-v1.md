...
- Its primitive specimen gallery includes Panel, Button, Input, Badge, specimen-only static Window/Datapad/Modal visual shells, and a visual-only Command Palette specimen.
...
| Primitive gallery | Shows Panel/Button/Input/Badge/Window/Datapad/Modal/Command Palette specimens. | Specimen-only, no production component migration. |
