...
2. `docs/living/NEXUS_CURRENT_STATE.md` ← 最新狀態
...
6. `docs/NEW_API_OPS_GUIDE.md` ← New API 運維
...
| 能用哪些模型 | deepseek-chat, deepseek-v4-pro, deepseek-v4-flash, gpt-4o-mini, gpt-4o, gemini-2.5-flash, gemini-2.5-pro, claude-sonnet-4, img2 |
...
| 19 | Zundo undo stack stores full workspace | ✅ Fixed — limit 50→20 (Phase 2A, `52ca0ac`) |
| 20 | reasoningContent persist bloat | 未處理 |
| 28 | Macro save no local queue | 未處理 |
| 33 | NexusOps god object | 未處理 |
| 23 | /api/models contract drift | 未處理 |
| 11 | Duplicate agent names (cosmetic UX) | 未處理 |
| 14-16 | Export wording/placeholders/names | 未處理 |
