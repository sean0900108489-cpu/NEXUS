...
export function PromptVaultManager() {
  ...
  return (
    ...
    >
      ...
      >
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-neutral-300/15 bg-white/[0.03] px-5">
          ...
          <button
            ...
            className="grid h-9 w-9 place-items-center border border-white/10 bg-white/[0.04] text-neutral-300 transition hover:border-neutral-300/50 hover:bg-neutral-300/10 hover:text-neutral-100"
        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 md:grid-cols-[360px_1fr]">
          <aside className="system-scroll min-h-0 overflow-y-auto border-b border-white/10 bg-black/20 p-3 md:border-b-0 md:border-r">
            {workspacePrompts.length ? (
                  ...
                  return (
                    <button
                      ...
                      className={cx(
                        ...
                        active
                          ? "border-neutral-300/45 bg-neutral-300/10 shadow-[0_0_24px_rgba(34,211,238,0.12)]"
                          : "border-white/10 bg-white/[0.035] hover:border-neutral-300/35 hover:bg-neutral-300/10",
                      )}
                      onClick={() => setSelectedPromptId(prompt.id)}
                      type="button"
                    >
                      <span className="block truncate font-mono text-[11px] uppercase tracking-[0.16em] text-neutral-100">
                        {prompt.title}
                      </span>
                      <span className="mt-2 block line-clamp-2 text-xs leading-5 text-neutral-400">
                        {getPromptPreview(prompt)}
                      </span>
                      <span className="mt-3 block font-mono text-[9px] uppercase tracking-[0.16em] text-neutral-600">
              ...
              <div className="grid h-full min-h-56 place-items-center border border-dashed border-white/10 bg-white/[0.02] p-6 text-center">
                <div>
                  ...
                  <p className="mt-3 font-mono text-[11px] uppercase tracking-[0.18em] text-neutral-400">
                    Vault Empty
                  </p>
          ...
          <section className="flex min-h-0 flex-col bg-zinc-950/40">
            {selectedPrompt ? (
              <>
                <div className="border-b border-white/10 p-5">
                  <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    <div className="min-w-0">
                      <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-neutral-200/80">
                        Selected Prompt
                      </p>
                    ...
                    <div className="flex shrink-0 items-center gap-2">
                      {editing ? null : (
                        <button
                          className="inline-flex h-9 items-center gap-2 border border-neutral-300/25 bg-neutral-300/5 px-3 font-mono text-[10px] uppercase tracking-[0.14em] text-neutral-100 transition hover:border-neutral-300/55 hover:bg-neutral-300/12"
                          onClick={startEdit}
                          type="button"
                        >
                          <Pen size={16} />
                ...
                <div className="system-scroll min-h-0 flex-1 overflow-y-auto p-5">
                  {editing ? (
                    <div className="grid gap-3">
                      <label className="grid gap-2">
                        ...
                        <input
                          className="border border-neutral-300/25 bg-black/35 px-3 py-2.5 font-mono text-sm text-white outline-none transition focus:border-neutral-300/60"
                      ...
                      <label className="grid min-h-[360px] gap-2">
                        ...
                        <textarea
                          className="system-scroll min-h-[360px] resize-none border border-neutral-300/25 bg-black/35 p-4 font-mono text-sm leading-6 text-neutral-100 outline-none transition focus:border-neutral-300/60"
                      ...
                      <div className="flex justify-end gap-2">
                        <button
                          className="border border-white/10 bg-white/[0.04] px-4 py-2 font-mono text-[10px] uppercase tracking-[0.14em] text-neutral-300 transition hover:border-white/25 hover:bg-white/10"
                          onClick={cancelEdit}
                          type="button"
                        >
                          Cancel
                        ...
                        <button
                          className="border border-neutral-300/35 bg-neutral-300/10 px-4 py-2 font-mono text-[10px] uppercase tracking-[0.14em] text-neutral-100 transition hover:border-neutral-300/60 hover:bg-neutral-300/20"
                          onClick={saveEdit}
                          type="button"
                        >
                          Save
                    ...
                    <pre className="min-h-full whitespace-pre-wrap border border-neutral-300/15 bg-black/35 p-4 font-mono text-sm leading-6 text-neutral-200 shadow-inner shadow-black/40">
              ...
              <div className="grid min-h-0 flex-1 place-items-center p-8 text-center">
                <div>
                  <Database className="mx-auto h-8 w-8 text-neutral-700" />
