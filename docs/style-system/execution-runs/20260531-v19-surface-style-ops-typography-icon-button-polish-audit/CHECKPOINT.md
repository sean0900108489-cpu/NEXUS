...
Starting HEAD: `b7378b8 feat: add surface style segmented nav specimen`

## Goal

Audit the remaining Surface Style Ops typography, icon, button, and density gaps
...
- `docs/style-system/execution-runs/20260531-v19-surface-style-ops-typography-icon-button-polish-audit/CHECKPOINT.md`
...
1. Icon/action chrome recipe
   - Current specimens still use text initials and small labels for many
     actions.
   - Reference needs restrained glyph controls in surface style shells.
...
Add a Style Lab-only Surface Style control polish specimen showing compact icon
