...
Starting HEAD: `530c466 feat: add warm glass right metrics specimen`

## Goal

Add a Style Lab-only Warm Glass Ops agent card bank recipe/specimen.
...
- warm glass left-side roster hierarchy inside the local scene preview
...
- `docs/style-system/execution-runs/20260531-v19-warm-glass-ops-agent-card-bank-specimen/CHECKPOINT.md`
...
expands the Warm Glass command-center header identity using direct aliases and
local preview data.
